		...
		<div class="row userhandling">
			...
			<div class="col-md-8">
				<div class="well user-search-well">
					<s2ui:form width='100%' height='220' elementId='formContainer'
		           titleCode='spring.security.ui.user.search'>
						...
						<g:form controller="user" action='userSearch' name='userSearchForm'>
							...
							<table>
								...
								<tr>
									<td colspan='4'>
										<s2ui:submitButton elementId='search' form='userSearchForm' messageCode='spring.security.ui.search'/>
									</td>
								</tr>
								</tbody>
							</table>
